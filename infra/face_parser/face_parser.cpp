...
Face FaceParser::parseWithTexture(string line) {
    int x, y, z;
...
bool FaceParser::isParsableWithTexture(string line) {
    int x, y, z;
    return sscanf(line.c_str(), "f %d/%*s %d/%*s %d/%*s", &x, &y, &z) == 3;
}

Face FaceParser::parseWithoutTexture(string line) {
    int x, y, z;
...
bool FaceParser::isParsableWithoutTexture(string line) {
    int x, y, z;
    return sscanf(line.c_str(), "f %d %d %d", &x, &y, &z) == 3;
}
